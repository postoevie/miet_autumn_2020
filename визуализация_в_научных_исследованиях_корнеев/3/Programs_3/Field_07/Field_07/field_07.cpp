//Z-буфер,    центральное проецирование,
// меню для изменения параметров визуализации
...
//длины координатных осей (в мировых координатах)(размеры куба)
	xmax=2, ymax=2, zmax=2;

//параметры центрального проектирования
dCentral = 4, cCentral = 3; 
...
//"рисует" выпуклый 4-полигон, цветом rgb, заполняя Z-буфер
//P[4] - координаты вершин в пиксельной плоскости
//Ze[4] - z-координаты вершин в видовой системе координат
